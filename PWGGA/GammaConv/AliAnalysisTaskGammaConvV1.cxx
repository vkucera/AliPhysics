...
AliAnalysisTaskGammaConvV1::AliAnalysisTaskGammaConvV1(): AliAnalysisTaskSE(),
  ...
  fHistoMCAllGammaConvRZAll(NULL),
  ...
  fHistoMCAllGammaEPosConvZAllPt(NULL),
  fHistoMCAllGammaENegConvZAllPt(NULL),
  ...
  fHistoMCPi0WOWeightPtFineBinning(NULL),
  ...
  fHistoMCEtaWOWeightPtFineBinning(NULL),
  ...
  fHistoTruePrimaryPi0MCPtPtFine(NULL),
  fHistoTruePrimaryEtaMCPtPtFine(NULL),
  ...
  fHistoTruePrimaryConvGammaMCPtMCEta(NULL),
...
//    binWidthPt                = 0.1;
  ...
  for (Int_t i = 0; i <= 80; ++i) {
    arrPtBinningFine[i] = 0.0 + 0.05*i;
  }
  for (Int_t i = 1; i <= 50; ++i) {
    arrPtBinningFine[80+i] = 4.0 + 0.1*i;
  }
  for (Int_t i = 1; i <= 12; ++i) {
    arrPtBinningFine[130+i] = 9.0 + 0.5*i;
  }
  ...
  for(Int_t iCut = 0; iCut<fnCuts;iCut++){
    ...
    fMLFolder[iCut]            = new TList();
    fMLFolder[iCut]->SetName(Form("ML_%s_%s_%s",cutstringEvent.Data() ,cutstringPhoton.Data(),cutstringMeson.Data()));
    fMLFolder[iCut]->SetOwner(kTRUE);
    //fOutputContainer->Add(fMLFolder[iCut]);
  ...
  if(fIsMC>0){
    ...
    fHistoMCAllGammaConvRZAll          = new TH2F*[fnCuts];
    ...
    fHistoMCAllGammaEPosConvZAllPt     = new TH2F*[fnCuts];
    fHistoMCAllGammaENegConvZAllPt     = new TH2F*[fnCuts];
    ...
    fHistoTruePrimaryConvGammaMCPtMCEta                   = new TH2F*[fnCuts];
    ...
    if (fDoPhotonQA > 0 ){
      if (fIsMC < 2 ){
        ...
        fHistoMCConvGammaPtR            = new TH2F*[fnCuts];
        ...
        fHistoTrueConvGammaPtR          = new TH2F*[fnCuts];
    ...
    if(fDoMesonAnalysis){
      ...
      if (fDoMesonQA > 0 && fIsMC < 2){
        fHistoMCPi0WOWeightPtFineBinning = new TH1F*[fnCuts];
        fHistoMCEtaWOWeightPtFineBinning = new TH1F*[fnCuts];
      }
      ...
      if (fDoMesonQA > 0){
        ...
        if (fIsMC < 2){
          ...
          if (fDoMesonQA == 4){
            fHistoTruePrimaryPi0MCPtPtFine        = new TH2F*[fnCuts];
            fHistoTruePrimaryEtaMCPtPtFine        = new TH2F*[fnCuts];
          }
    ...
    for(Int_t iCut = 0; iCut<fnCuts;iCut++){
      ...
      if (fDoPhotonQA > 0) {
        fHistoMCConvGammaPtMatBudWeights[iCut] = new TH1F("MC_ConvGamma_MatBudWeights_Pt",
                                                          "MC_ConvGamma_MatBudWeights_Pt",
      ...
      if (fDoPhotonQA > 0) {
        fHistoMCConvGammaSelectionAODPt[iCut] = new TH2F("MC_ConvGammaSelectionAOD_Pt",
                                                         "MC_ConvGammaSelectionAOD_Pt",
                                                         nBinsPt, arrPtBinning, 9, -0.5, 8.5);
        fHistoMCConvGammaSelectionAODPt[iCut]->GetYaxis()->SetBinLabel(1, "all selected gamma");
        fHistoMCConvGammaSelectionAODPt[iCut]->GetYaxis()->SetBinLabel(2, "NDaughters < 2");
        fHistoMCConvGammaSelectionAODPt[iCut]->GetYaxis()->SetBinLabel(3, "no process-5 e+e-");
        fHistoMCConvGammaSelectionAODPt[iCut]->GetYaxis()->SetBinLabel(4, "daughter eta");
        fHistoMCConvGammaSelectionAODPt[iCut]->GetYaxis()->SetBinLabel(5, "R > max");
        fHistoMCConvGammaSelectionAODPt[iCut]->GetYaxis()->SetBinLabel(6, "|Z| > max");
        fHistoMCConvGammaSelectionAODPt[iCut]->GetYaxis()->SetBinLabel(7, "line cut min R");
        ...
        fHistoMCAllGammaDaughterStatusPt[iCut] = new TH2F("MC_AllGamma_DaughterStatus_Pt",
                                                          ...
                                                          nBinsPt, arrPtBinning, 7, -0.5, 6.5);
        fHistoMCAllGammaDaughterStatusPt[iCut]->GetYaxis()->SetBinLabel(1, "all selected gamma");
        fHistoMCAllGammaDaughterStatusPt[iCut]->GetYaxis()->SetBinLabel(2, "NDaughters < 1");
        fHistoMCAllGammaDaughterStatusPt[iCut]->GetYaxis()->SetBinLabel(3, "NDaughters == 1");
        fHistoMCAllGammaDaughterStatusPt[iCut]->GetYaxis()->SetBinLabel(4, "NDaughters >= 2");
        fHistoMCAllGammaDaughterStatusPt[iCut]->GetYaxis()->SetBinLabel(5, "process-5 e+e-");
        fHistoMCAllGammaDaughterStatusPt[iCut]->GetYaxis()->SetBinLabel(6, "non-process-5 e+e-");
        fHistoMCAllGammaDaughterStatusPt[iCut]->GetYaxis()->SetBinLabel(7, "one process-5 e");
        fMCList[iCut]->Add(fHistoMCAllGammaDaughterStatusPt[iCut]);

        fHistoMCAllGammaConvRAllPt[iCut] = new TH2F("MC_AllGamma_ConvRAll_Pt_R",
                                                    "MC_AllGamma_ConvRAll_Pt_R",
                                                    nBinsPt, arrPtBinning, 800, 0, 400);
        fMCList[iCut]->Add(fHistoMCAllGammaConvRAllPt[iCut]);
        fHistoMCAllGammaConvZAllPt[iCut] = new TH2F("MC_AllGamma_ConvZAll_Pt_Z",
                                                    "MC_AllGamma_ConvZAll_Pt_Z",
                                                    nBinsPt, arrPtBinning, 1000, -500, 500);
        fMCList[iCut]->Add(fHistoMCAllGammaConvZAllPt[iCut]);
        fHistoMCAllGammaConvRZAll[iCut] = new TH2F("MC_AllGamma_ConvRZAll_R_Z",
                                                   "MC_AllGamma_ConvRZAll_R_Z",
                                                   800, 0, 400, 1000, -500, 500);
        fMCList[iCut]->Add(fHistoMCAllGammaConvRZAll[iCut]);
        fHistoMCAllGammaDaughterPt[iCut] = new TH2F("MC_AllGamma_DaughterPt_Pt",
                                                    "MC_AllGamma_DaughterPt_Pt",
                                                    nBinsPt, arrPtBinning, nBinsPt, arrPtBinning);
        fMCList[iCut]->Add(fHistoMCAllGammaDaughterPt[iCut]);
        fHistoMCAllGammaDaughterEta[iCut] = new TH2F("MC_AllGamma_DaughterEta_Pt_Eta",
                                                     "MC_AllGamma_DaughterEta_Pt_Eta",
                                                     nBinsPt, arrPtBinning, 1000, -5, 5);
        fMCList[iCut]->Add(fHistoMCAllGammaDaughterEta[iCut]);
        fHistoMCAllGammaNDaughtersPt[iCut] = new TH2F("MC_AllGamma_NDaughters_Pt",
        ...
        fMCList[iCut]->Add(fHistoMCAllGammaDaughterElectronProcessPt[iCut]);
        fHistoMCAllGammaEPosConvRAllPt[iCut] = new TH2F("MC_AllGamma_EPosConvRAll_Pt_R",
                                                        "MC_AllGamma_EPosConvRAll_Pt_R",
                                                        nBinsPt, arrPtBinning, 800, 0, 400);
        fMCList[iCut]->Add(fHistoMCAllGammaEPosConvRAllPt[iCut]);
        fHistoMCAllGammaENegConvRAllPt[iCut] = new TH2F("MC_AllGamma_ENegConvRAll_Pt_R",
                                                        "MC_AllGamma_ENegConvRAll_Pt_R",
                                                        nBinsPt, arrPtBinning, 800, 0, 400);
        fMCList[iCut]->Add(fHistoMCAllGammaENegConvRAllPt[iCut]);
        fHistoMCAllGammaEPosConvZAllPt[iCut] = new TH2F("MC_AllGamma_EPosConvZAll_Pt_Z",
                                                        "MC_AllGamma_EPosConvZAll_Pt_Z",
                                                        nBinsPt, arrPtBinning, 1000, -500, 500);
        fMCList[iCut]->Add(fHistoMCAllGammaEPosConvZAllPt[iCut]);
        fHistoMCAllGammaENegConvZAllPt[iCut] = new TH2F("MC_AllGamma_ENegConvZAll_Pt_Z",
                                                        "MC_AllGamma_ENegConvZAll_Pt_Z",
                                                        nBinsPt, arrPtBinning, 1000, -500, 500);
        fMCList[iCut]->Add(fHistoMCAllGammaENegConvZAllPt[iCut]);
        fHistoMCAllGammaSingleProcess5ConvRAllPt[iCut] = new TH2F("MC_AllGamma_SingleProcess5ConvRAll_Pt_R",
                                                                  "MC_AllGamma_SingleProcess5ConvRAll_Pt_R",
                                                                  nBinsPt, arrPtBinning, 800, 0, 400);
        fMCList[iCut]->Add(fHistoMCAllGammaSingleProcess5ConvRAllPt[iCut]);
        fHistoMCAllGammaSingleProcess5ConvZAllPt[iCut] = new TH2F("MC_AllGamma_SingleProcess5ConvZAll_Pt_Z",
                                                                  "MC_AllGamma_SingleProcess5ConvZAll_Pt_Z",
                                                                  nBinsPt, arrPtBinning, 1000, -500, 500);
        fMCList[iCut]->Add(fHistoMCAllGammaSingleProcess5ConvZAllPt[iCut]);
        fHistoMCAllGammaSingleProcess5SignPt[iCut] = new TH2F("MC_AllGamma_SingleProcess5Sign_Pt",
                                                              "MC_AllGamma_SingleProcess5Sign_Pt",
                                                              nBinsPt, arrPtBinning, 3, -1.5, 1.5);
        fHistoMCAllGammaSingleProcess5SignPt[iCut]->GetYaxis()->SetBinLabel(1, "e- only");
        ...
        if (fDoPhotonQA == 6) {
          ...
          for (Int_t i = 0; i <= 100; i++) {
            arrMinDaughterPtBinning[i] = 0.002*i;
          }
          for (Int_t i = 1; i <= 90; i++) {
            arrMinDaughterPtBinning[100+i] = 0.2 + 0.02*i;
          }
          for (Int_t i = 1; i <= 32; i++) {
            arrMinDaughterPtBinning[190+i] = 2.0 + 0.25*i;
          }

          const Int_t nGammaMotherBins[8] = {nBinsPtFine, 32, 36, 80, 200, 160, 150, 7002};
          const Double_t gammaMotherXMin[8] = {arrPtBinningFine[0], -0.8, 0., -20., 0., -4., 0., -3500.5};
          const Double_t gammaMotherXMax[8] = {arrPtBinningFine[nBinsPtFine], 0.8, TMath::TwoPi(), 20., 20., 4., 1.5, 3501.5};
          ...
          fSparseMCAllGammaPtEtaPhiEventZMother[iCut]->GetAxis(0)->Set(nBinsPtFine, arrPtBinningFine);
          ...
          const Int_t nConvMotherBins[9] = {nBinsPtFine, 32, 36, 80, 160, 200, 160, 150, 7002};
          const Double_t convMotherXMin[9] = {arrPtBinningFine[0], -0.8, 0., -20., 0., 0., -4., 0., -3500.5};
          const Double_t convMotherXMax[9] = {arrPtBinningFine[nBinsPtFine], 0.8, TMath::TwoPi(), 20., 200., 20., 4., 1.5, 3501.5};
          ...
          fSparseMCConvGammaPtEtaPhiEventZRMother[iCut]->GetAxis(0)->Set(nBinsPtFine, arrPtBinningFine);
          ...
          fSparseMCConvGammaPtEtaPhiRZDaughter[iCut]->GetAxis(0)->Set(nBinsPtFine, arrPtBinningFine);
          ...
          fSparseMCConvGammaPtEtaPhiRZDaughter[iCut]->GetAxis(5)->Set(nBinsMinDaughterPt, arrMinDaughterPtBinning);
          ...
          fSparseMCConvGammaPtRMinDaughterPtAsymFrac[iCut]->GetAxis(0)->Set(nBinsPtFine, arrPtBinningFine);
      ...
      if (fIsMC > 1){
        ...
        if (fDoPhotonQA > 0) {
          ...
          fHistoMCAllGammaConvRZAll[iCut]->Sumw2();
          ...
          fHistoMCAllGammaEPosConvZAllPt[iCut]->Sumw2();
          fHistoMCAllGammaENegConvZAllPt[iCut]->Sumw2();
      ...
      if (fDoPhotonQA > 0 && fIsMC < 2){
        ...
        fHistoMCConvGammaPtR[iCut]         = new TH2F("MC_ConvGamma_Pt_R", "MC_ConvGamma_Pt_R", nBinsPt, arrPtBinning, 800, 0, 200);
        fMCList[iCut]->Add(fHistoMCConvGammaPtR[iCut]);
      ...
      if (fDoMesonQA > 0){
        ...
        if (fIsMC < 2){
          fHistoMCPi0WOWeightPtFineBinning[iCut] = new TH1F("MC_Pi0_WOWeights_Pt_FineBinning", "MC_Pi0_WOWeights_Pt_FineBinning", nBinsPtFine, arrPtBinningFine);
          fHistoMCPi0WOWeightPtFineBinning[iCut]->Sumw2();
          fMCList[iCut]->Add(fHistoMCPi0WOWeightPtFineBinning[iCut]);
          fHistoMCEtaWOWeightPtFineBinning[iCut] = new TH1F("MC_Eta_WOWeights_Pt_FineBinning", "MC_Eta_WOWeights_Pt_FineBinning", nBinsPtFine, arrPtBinningFine);
          fHistoMCEtaWOWeightPtFineBinning[iCut]->Sumw2();
          fMCList[iCut]->Add(fHistoMCEtaWOWeightPtFineBinning[iCut]);
      ...
      if (fDoPhotonQA > 0) {
        fHistoTruePrimaryConvGammaMCPtMCEta[iCut] = new TH2F("ESD_TruePrimaryConvGamma_MCPt_MCEta", "ESD_TruePrimaryConvGamma_MCPt_MCEta", nBinsPt, arrPtBinning, 1000, -2, 2);
        fTrueList[iCut]->Add(fHistoTruePrimaryConvGammaMCPtMCEta[iCut]);
      }
      ...
      if ((fIsMC > 1)  || (fDoMaterialBudgetWeightingOfGammasForTrueMesons && fIsMC > 0) ) {
        ...
        if (fDoPhotonQA > 0) fHistoTruePrimaryConvGammaMCPtMCEta[iCut]->Sumw2();
      ...
      if (fDoPhotonQA > 0 ){
        if (fIsMC < 2){
          ...
          fHistoTrueConvGammaPtR[iCut]            = new TH2F("ESD_TrueConvGamma_Pt_R", "ESD_TrueConvGamma_Pt_R", nBinsPt, arrPtBinning, 800, 0, 200);
          fTrueList[iCut]->Add(fHistoTrueConvGammaPtR[iCut]);
        ...
        fHistoTrueConvGammaRecoStageMCPt[iCut] = new TH2F("ESD_TrueConvGammaRecoStage_MCPt",
                                                          "ESD_TrueConvGammaRecoStage_MCPt",
                                                          nBinsPt, arrPtBinning, 6, -0.5, 5.5);
        fHistoTrueConvGammaRecoStageMCPt[iCut]->GetYaxis()->SetBinLabel(1, "common MC mother");
        fHistoTrueConvGammaRecoStageMCPt[iCut]->GetYaxis()->SetBinLabel(2, "true photon");
        fHistoTrueConvGammaRecoStageMCPt[iCut]->GetYaxis()->SetBinLabel(3, "process-5 e+e-");
        fHistoTrueConvGammaRecoStageMCPt[iCut]->GetYaxis()->SetBinLabel(4, "primary");
        ...
        if (fDoPhotonQA == 6) {
          ...
          const Int_t nTrueConvMotherBins[9] = {nBinsPtFine, 32, 36, 80, 160, 200, 160, 150, 7002};
          const Double_t trueConvMotherXMin[9] = {arrPtBinningFine[0], -0.8, 0., -20., 0., 0., -4., 0., -3500.5};
          const Double_t trueConvMotherXMax[9] = {arrPtBinningFine[nBinsPtFine], 0.8, TMath::TwoPi(), 20., 200., 20., 4., 1.5, 3501.5};
          ...
          fSparseTruePrimaryConvGammaPtEtaPhiEventZRMother[iCut]->GetAxis(0)->Set(nBinsPtFine, arrPtBinningFine);
          ...
          fSparseTruePrimaryConvGammaPtEtaPhiRZDaughter[iCut]->GetAxis(0)->Set(nBinsPtFine, arrPtBinningFine);
          ...
          fSparseTruePrimaryConvGammaPtEtaPhiRZDaughter[iCut]->GetAxis(5)->Set(nBinsMinDaughterPt, arrMinDaughterPtBinning);
          ...
          fSparseTruePrimaryConvGammaPtRMinDaughterPtAsymFrac[iCut]->GetAxis(0)->Set(nBinsPtFine, arrPtBinningFine);
          ...
          const Double_t trueConvStageTopoXMin[4] = {arrPtBinningFine[0], -0.5, 0., 0.};
          const Double_t trueConvStageTopoXMax[4] = {arrPtBinningFine[nBinsPtFine], 5.5, 200., arrMinDaughterPtBinning[nBinsMinDaughterPt]};
          ...
          fSparseTrueConvGammaRecoStagePtRMinDaughterPt[iCut]->GetAxis(0)->Set(nBinsPtFine, arrPtBinningFine);
          ...
          fSparseTrueConvGammaRecoStagePtRMinDaughterPt[iCut]->GetAxis(3)->Set(nBinsMinDaughterPt, arrMinDaughterPtBinning);
      ...
      if(fDoMesonAnalysis){
        ...
        if (fDoMesonQA > 0){
          if (fIsMC < 2){
            ...
            if (fDoMesonQA == 4){
              fHistoTruePrimaryPi0MCPtPtFine[iCut] = new TH2F("ESD_TruePrimaryPi0_MCPt_Pt_Fine", "ESD_TruePrimaryPi0_Pt_MCPt_Fine", nBinsPtFine, arrPtBinningFine, nBinsPtFine, arrPtBinningFine);
              fHistoTruePrimaryPi0MCPtPtFine[iCut]->Sumw2();
              fTrueList[iCut]->Add(fHistoTruePrimaryPi0MCPtPtFine[iCut]);
              fHistoTruePrimaryEtaMCPtPtFine[iCut] = new TH2F("ESD_TruePrimaryEta_MCPt_Pt_Fine", "ESD_TruePrimaryEta_Pt_MCPt_Fine", nBinsPtFine, arrPtBinningFine, nBinsPtFine, arrPtBinningFine);
              fHistoTruePrimaryEtaMCPtPtFine[iCut]->Sumw2();
              fTrueList[iCut]->Add(fHistoTruePrimaryEtaMCPtPtFine[iCut]);
            }
...
void AliAnalysisTaskGammaConvV1::ProcessPhotonCandidates()
{
  ...
  if (fDoTreeForPhotonML) // Getting all Photon candidates and noting down their properties 
  {
    ...
    if(ENegTrack && EPosTrack ) {
      ...
      } else  {fDeDx_TPC_EPos_PhotonML =  fiPhotonCut->GetCorrectedElectronTPCResponse(EPosTrack->Charge(),pidResonse->NumberOfSigmasTPC(EPosTrack,AliPID::kElectron), EPosTrack->P(), EPosTrack->Eta(), EPosTrack->GetTPCNcls(),PhotonCandidate->GetConversionRadius() ); }
...
void AliAnalysisTaskGammaConvV1::ProcessTruePhotonCandidatesAOD(AliAODConversionPhoton *TruePhotonCandidate)
{
  ...
  if (fAODMCTrackArray != NULL && TruePhotonCandidate != NULL){
    ...
    AliAODMCParticle *Photon = (AliAODMCParticle*) fAODMCTrackArray->At(posDaughter->GetMother());
    const Float_t recoStageWeight = fWeightJetJetMC;
    if (fDoPhotonQA > 0) fHistoTrueConvGammaRecoStageMCPt[fiCut]->Fill(Photon->Pt(), 0., recoStageWeight);
    ...
    if (fDoPhotonQA > 0) fHistoTrueConvGammaRecoStageMCPt[fiCut]->Fill(Photon->Pt(), 1., recoStageWeight);
    if (fDoPhotonQA == 6) {
    ...
    if (fDoPhotonQA > 0 ){
      if (fIsMC < 2){
        fHistoTrueConvGammaPsiPairPt[fiCut]->Fill(TruePhotonCandidate->GetPsiPair(),TruePhotonCandidate->Pt(),weightedTruePhotonWeight);
        fHistoTrueConvGammaEta[fiCut]->Fill(TruePhotonCandidate->Eta(),weightedTruePhotonWeight);
        fHistoTrueConvGammaR[fiCut]->Fill(TruePhotonCandidate->GetConversionRadius(),weightedTruePhotonWeight);
        fHistoTrueConvGammaPtR[fiCut]->Fill(TruePhotonCandidate->Pt(),TruePhotonCandidate->GetConversionRadius(),weightedTruePhotonWeight);
        fHistoTrueConvGammaRMC[fiCut]->Fill(rConv,weightedTruePhotonWeight);
      }
      fHistoTrueConvGammaPtMC[fiCut]->Fill(Photon->Pt(), weightedTruePhotonWeight);
    }
    fHistoTrueGammaPsiPairDeltaPhi[fiCut]->Fill(deltaPhi,TruePhotonCandidate->GetPsiPair(),weightedTruePhotonWeight);
...
void AliAnalysisTaskGammaConvV1::ProcessTruePhotonCandidates(AliAODConversionPhoton *TruePhotonCandidate)
{
  ...
  if (fDoPhotonQA > 0){
    if (fIsMC < 2){
      fHistoTrueConvGammaPsiPairPt[fiCut]->Fill(TruePhotonCandidate->GetPsiPair(),TruePhotonCandidate->Pt(),qaTruePhotonWeight);
      fHistoTrueConvGammaEta[fiCut]->Fill(TruePhotonCandidate->Eta(),qaTruePhotonWeight);
      fHistoTrueConvGammaR[fiCut]->Fill(TruePhotonCandidate->GetConversionRadius(),qaTruePhotonWeight);
      fHistoTrueConvGammaRMC[fiCut]->Fill(posDaughter->Particle()->R(),qaTruePhotonWeight);
      if ((fDoPhotonQA == 4)||(fDoPhotonQA == 5)){
        fHistoTrueConvGammaInvMass[fiCut]->Fill(TruePhotonCandidate->GetMass(),qaTruePhotonWeight);
        fHistoTrueConvGammaInvMassReco[fiCut]->Fill(GetOriginalInvMass(TruePhotonCandidate,fInputEvent),qaTruePhotonWeight);
      }
    }
  ...
  if (fiEventCut->IsConversionPrimaryESD( fMCEvent, posDaughter->GetMother(), mcProdVtxX, mcProdVtxY, mcProdVtxZ)){
    ...
    if( Photon->GetMother() > -1 && fMCEvent->GetTrack(Photon->GetMother())->GetMother() > -1){
      if (fMCEvent->GetTrack(fMCEvent->GetTrack(Photon->GetMother())->GetMother())->PdgCode() == 310){
        ...
        iPhotonMCInfo = 3;
        fHistoTrueSecondaryConvGammaPt[fiCut]->Fill(Photon->Pt(),3.,totalTruePhotonWeight);
        fHistoTrueSecondaryConvGammaMCPt[fiCut]->Fill(TruePhotonCandidate->Pt(),3.,totalTruePhotonWeight);
      } else {
      ...
      if (isPrimary){
        ...
        if(fiPhotonCut->PhotonIsSelectedAODMC(particle,fAODMCTrackArray,kFALSE /*checkForConvertedGamma*/ )){
          ...
          if (fDoPhotonQA > 0) fHistoMCAllGammaMCPtMCEta[fiCut]->Fill(particle->Pt(),particle->Eta(),totalPhotonWeight);
            ...
            Bool_t hasNonProcess5EPos = kFALSE;
            Bool_t hasNonProcess5ENeg = kFALSE;
            ...
            if (nDaughters < 1) {
              ...
              fHistoMCAllGammaDaughterStatusPt[fiCut]->Fill(particle->Pt(), 2., totalPhotonWeight);
            } else {
              fHistoMCAllGammaDaughterStatusPt[fiCut]->Fill(particle->Pt(), 3., totalPhotonWeight);
            }
            ...
            if (nDaughters > 0) {
              for (Int_t daughterIndex = particle->GetDaughterLabel(0); daughterIndex <= particle->GetDaughterLabel(1); daughterIndex++) {
                ...
                fHistoMCAllGammaDaughterElectronProcessPt[fiCut]->Fill(particle->Pt(), tmpDaughter->GetMCProcessCode(), totalPhotonWeight);
                ...
                if (tmpDaughter->GetMCProcessCode() == 5) {
                  ...
                  if (tmpDaughter->GetPdgCode() == 11) {
                    hasNonProcess5ENeg = kTRUE;
                  } else if (tmpDaughter->GetPdgCode() == -11) {
                    hasNonProcess5EPos = kTRUE;
                  }
                }
              }
            }
            ...
            if (ePosProcess5 && eNegProcess5) {
              fHistoMCAllGammaDaughterStatusPt[fiCut]->Fill(particle->Pt(), 4., totalPhotonWeight);
              AliAODMCParticle* process5Daughters[2] = {ePosProcess5, eNegProcess5};
              for (Int_t iDaughter = 0; iDaughter < 2; iDaughter++) {
                const Double_t rDaughter = TMath::Sqrt(process5Daughters[iDaughter]->Xv() * process5Daughters[iDaughter]->Xv() +
                                                       process5Daughters[iDaughter]->Yv() * process5Daughters[iDaughter]->Yv());
                const Double_t zDaughter = process5Daughters[iDaughter]->Zv();
                fHistoMCAllGammaConvRAllPt[fiCut]->Fill(particle->Pt(), rDaughter, totalPhotonWeight);
                fHistoMCAllGammaConvZAllPt[fiCut]->Fill(particle->Pt(), zDaughter, totalPhotonWeight);
                fHistoMCAllGammaConvRZAll[fiCut]->Fill(rDaughter, zDaughter, totalPhotonWeight);
                fHistoMCAllGammaDaughterPt[fiCut]->Fill(particle->Pt(), process5Daughters[iDaughter]->Pt(), totalPhotonWeight);
                fHistoMCAllGammaDaughterEta[fiCut]->Fill(particle->Pt(), process5Daughters[iDaughter]->Eta(), totalPhotonWeight);
              }
              ...
              fHistoMCAllGammaEPosConvRAllPt[fiCut]->Fill(particle->Pt(), rEPos, totalPhotonWeight);
              ...
              const Double_t rSingle = TMath::Sqrt(singleProcess5Daughter->Xv() * singleProcess5Daughter->Xv() +
                                                   singleProcess5Daughter->Yv() * singleProcess5Daughter->Yv());
              fHistoMCAllGammaSingleProcess5ConvRAllPt[fiCut]->Fill(particle->Pt(), rSingle, totalPhotonWeight);
              fHistoMCAllGammaSingleProcess5ConvZAllPt[fiCut]->Fill(particle->Pt(), singleProcess5Daughter->Zv(), totalPhotonWeight);
              fHistoMCAllGammaSingleProcess5SignPt[fiCut]->Fill(particle->Pt(), ePosProcess5 ? 1. : -1., totalPhotonWeight);
            }
            if (hasNonProcess5EPos && hasNonProcess5ENeg) {
              fHistoMCAllGammaDaughterStatusPt[fiCut]->Fill(particle->Pt(), 5., totalPhotonWeight);
            }
          }
          if(isCurrentEventSelected == 1){
            ...
            fHistoMCAllGammaPtNoVertex[fiCut]->Fill(particle->Pt(),totalPhotonWeight);
          }
          if(particle->GetMother() >-1){ // Meson Decay Gamma
            ...
            case 111: // Pi0
            fHistoMCDecayGammaPi0Pt[fiCut]->Fill(particle->Pt(),totalPhotonWeight);
            break;
            case 113: // Rho0
            fHistoMCDecayGammaRhoPt[fiCut]->Fill(particle->Pt(),totalPhotonWeight);
            break;
            case 221: // Eta
            fHistoMCDecayGammaEtaPt[fiCut]->Fill(particle->Pt(),totalPhotonWeight);
            break;
            case 223: // Omega
            fHistoMCDecayGammaOmegaPt[fiCut]->Fill(particle->Pt(),totalPhotonWeight);
            break;
            case 331: // Eta'
            fHistoMCDecayGammaEtapPt[fiCut]->Fill(particle->Pt(),totalPhotonWeight);
            break;
            case 333: // Phi
            fHistoMCDecayGammaPhiPt[fiCut]->Fill(particle->Pt(),totalPhotonWeight);
            break;
            case 3212: // Sigma
            fHistoMCDecayGammaSigmaPt[fiCut]->Fill(particle->Pt(),totalPhotonWeight);
            break;
            }
          }
        }
        ...
        /*  SFS: all conversion primary mesons get the pt weight. 
            ...
            if(particle->GetPdgCode() == 111){
              ...
              if (fDoMesonQA > 0 && fIsMC < 2) fHistoMCPi0WOWeightPtFineBinning[fiCut]->Fill(particle->Pt(),fWeightJetJetMC);
              ...
              if (fDoMesonQA > 0 && fIsMC < 2) fHistoMCEtaWOWeightPtFineBinning[fiCut]->Fill(particle->Pt(),fWeightJetJetMC);
  ...
  for(Long_t i = 0; i < fMCEvent->GetNumberOfTracks(); i++) {
    ...
    if (fiEventCut->IsConversionPrimaryESD( fMCEvent, i, mcProdVtxX, mcProdVtxY, mcProdVtxZ)){
      ...
      if(fiPhotonCut->PhotonIsSelectedMC(particle,fMCEvent,kTRUE)){
        ...
        fHistoMCConvGammaPt[fiCut]->Fill(particle->Pt(),totalPhotonWeight);
        if (fDoPhotonQA > 0) {
          const Float_t rConv = ((AliMCParticle*)fMCEvent->GetTrack(particle->GetDaughterFirst()))->Particle()->R();
          Float_t weightMatBudgetGamma = 1.;
          if (fDoMaterialBudgetWeightingOfGammasForTrueMesons && fiPhotonCut->GetMaterialBudgetWeightsInitialized()) {
            weightMatBudgetGamma = fiPhotonCut->GetMaterialBudgetCorrectingWeightForTrueGamma(rConv, particle->Pt(), fInputEvent->GetMagneticField());
          }
  ...
  if(fGammaCandidates->GetEntries()>1){ 
    for(Int_t firstGammaIndex=0;firstGammaIndex<fGammaCandidates->GetEntries()-1;firstGammaIndex++){
      ...
      for(Int_t secondGammaIndex=firstGammaIndex+1;secondGammaIndex<fGammaCandidates->GetEntries();secondGammaIndex++){
        ...
        AliVTrack * ENegTrack_Gamma0 = fiPhotonCut->GetTrack(fInputEvent, gamma0->GetTrackLabelNegative());
        AliVTrack * EPosTrack_Gamma0 = fiPhotonCut->GetTrack(fInputEvent, gamma0->GetTrackLabelPositive());
    
        AliVTrack * ENegTrack_Gamma1 = fiPhotonCut->GetTrack(fInputEvent, gamma1->GetTrackLabelNegative());
        AliVTrack * EPosTrack_Gamma1 = fiPhotonCut->GetTrack(fInputEvent, gamma1->GetTrackLabelPositive());
        ...
        if((fiMesonCut->MesonIsSelected(pi0cand,kTRUE,fiEventCut->GetEtaShift()))){
          ...
          if (fDoTreeForMesonML){ // MesonML fill
            ...
            fInvMass_MesonML = pi0cand->M();
            if ((pion_mass_left > fInvMass_MesonML) || ((pion_mass_right < fInvMass_MesonML ) && (fInvMass_MesonML < eta_mass_left )) || (fInvMass_MesonML > eta_mass_right)) continue;
            ...
            } else  {fDeDx_TPC_EPos_Gamma0_MesonML =  fiPhotonCut->GetCorrectedElectronTPCResponse(EPosTrack_Gamma0->Charge(),pidResonse->NumberOfSigmasTPC(EPosTrack_Gamma0,AliPID::kElectron), EPosTrack_Gamma0->P(), EPosTrack_Gamma0->Eta(), EPosTrack_Gamma0->GetTPCNcls(),gamma0->GetConversionRadius() ); }
            ...
            if(fIsMC>0){
              ...
              if (fAODMCTrackArray!=NULL && gamma0 != NULL){
                ...
                positiveMC = static_cast<AliAODMCParticle*>(fAODMCTrackArray->At(gamma1->GetMCLabelPositive()));
                negativeMC = static_cast<AliAODMCParticle*>(fAODMCTrackArray->At(gamma1->GetMCLabelNegative()));
              ...
              if ((fGammaCandidates->GetEntries())%20==1) TreeForMesonML[fiCut]->AutoSave("FlushBaskets");
               TreeForMesonML[fiCut]->Fill();
            } 
          }
      ...
      if(!isPrimary){ // Secondary Meson
        ...
        if (fDoMesonQA > 0 && fIsMC < 2){
          ...
          if(isTruePi0){ // Only primary pi0 for resolution
            ...
            if (fDoMesonQA == 4) {
              fHistoTruePrimaryPi0MCPtPtFine[fiCut]->Fill(lMotherMCPt,
                                                          Pi0Candidate->Pt());
            }
          ...
          if (isTrueEta){ // Only primary eta for resolution
            fHistoTruePrimaryEtaMCPtResolPt[fiCut]->Fill(lMotherMCPt,
                                                         ...
                                                         weighted*weightMatBudget);
            if (fDoMesonQA == 4) {
              fHistoTruePrimaryEtaMCPtPtFine[fiCut]->Fill(lMotherMCPt,
                                                          Pi0Candidate->Pt());
            }
          }
        }
...
//________________________________________________________________________
UInt_t AliAnalysisTaskGammaConvV1::IsTruePhotonESD(AliAODConversionPhoton *TruePhotonCandidate)
{
  UInt_t kind = 9;
  ...
  if(posDaughter == NULL || negDaughter == NULL) {
    ...
    Bool_t gammaIsPrimary = fiEventCut->IsConversionPrimaryESD( fMCEvent, posDaughter->GetMother(), mcProdVtxX, mcProdVtxY, mcProdVtxZ);
...
//________________________________________________________________________
UInt_t AliAnalysisTaskGammaConvV1::IsTruePhotonAOD(AliAODConversionPhoton *TruePhotonCandidate)
{   
